...
public class MenuUtama extends javax.swing.JFrame {
    ...
    private List<Mk> mkList = new ArrayList<Mk>();
    private List<WaktuKrs> wktList = new ArrayList<WaktuKrs>();
    ...
    private WaktuKrsInterf wktService;
    ...
    private void initComponents() {
        ...
        txtJumlahKrs.setEditable(false);
        ...
        panelMhsLayout.setHorizontalGroup(
            ...
            .addGroup(panelMhsLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelMhsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtJumlahKrs, javax.swing.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)
                    .addComponent(txtNama, javax.swing.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)
                    .addComponent(txtNim, javax.swing.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE))
                .addGap(47, 47, 47)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelMhsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(TxtDsn, javax.swing.GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE)
                    .addComponent(TxtJur, javax.swing.GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE)
                    .addComponent(txtTa, javax.swing.GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(panelBotton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 592, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGap(0, 434, Short.MAX_VALUE)
                        .addComponent(tglFormat, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        ...
        try {
            ...
            if(detailList.isEmpty()){
                ...
                for (int a = 0; a < mk2List.size(); a++) {
                    ...
                    dt.setWktu((Date) tglFormat.getValue());
                    dt.setNim(txtNim.getText());
                    dt.setKd_mk(mk2List.get(a).getKd_mk());
                    detailService.insert(dt);
                }
                mhsService.insertJmlhKrs(Integer.parseInt(txtJumlahKrs.getText()),mhsPerson.getNim());
                System.out.println();
                System.out.println("masuk pertama kali");
                detailList = detailService.getByNim(mhsPerson.getNim());
                JOptionPane.showMessageDialog(this, "Data sudah Tersimpan", "Pemberitahuan", JOptionPane.INFORMATION_MESSAGE);
            }else{
                detailService.delete(mhsPerson.getNim());
                for (int a = 0; a < mk2List.size(); a++) {
                    DetailKrs dt = new DetailKrs();
                    dt.setWktu((Date) tglFormat.getValue());
                    dt.setNim(txtNim.getText());
